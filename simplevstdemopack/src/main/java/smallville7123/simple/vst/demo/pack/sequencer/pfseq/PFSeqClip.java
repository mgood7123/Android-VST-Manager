...
import static smallville7123.simple.vst.demo.pack.sequencer.pfseq.PFSeq.MICROS_PER_SECOND;
import static smallville7123.simple.vst.demo.pack.sequencer.pfseq.PFSeq.NANO_PER_MICROS;
import static smallville7123.simple.vst.demo.pack.sequencer.pfseq.PFSeqConfig.MAX_CLIP_FRAMES;
...
public class PFSeqClip {
    ...
    public boolean load() {
        ...
        try {
            this.mediaFormat = smallville7123.simple.vst.demo.pack.sequencer.pfseq.PFSeqAudio.getMediaFormat(file);
        } catch (Exception e) {
        ...
        try {
            this.pcm = smallville7123.simple.vst.demo.pack.sequencer.pfseq.PFSeqAudio.getPcm(file);
        } catch (Exception e) {
